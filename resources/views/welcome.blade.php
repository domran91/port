...
<div class="container">
    ...
    <div class="row featurette">
        <div class="col-md-7">
            ...
            <p class="lead">While I have worked on many projects not many are live right now. So I this site to demonstrate my programming skills and at the same time present to you my resume. Thank you for considering me for you job position. Now lets take the next step and start planning and creation the next big thing together.</p>
        </div>
        <div class="col-md-5">
